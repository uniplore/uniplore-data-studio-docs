...
DROP TABLE IF EXISTS `wy_dim_actor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_actor` (
...
DROP TABLE IF EXISTS `wy_dim_customer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_customer` (
  ...
  CONSTRAINT `dim_location_address_dim_customer_fk` FOREIGN KEY (`location_address_key`) REFERENCES `wy_dim_location_address` (`location_address_key`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `wy_dim_date`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_date` (
...
DROP TABLE IF EXISTS `wy_dim_film`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_film` (
...
DROP TABLE IF EXISTS `wy_dim_film_actor_bridge`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_film_actor_bridge` (
  ...
  CONSTRAINT `dim_actor_dim_film_actor_bridge_fk` FOREIGN KEY (`actor_key`) REFERENCES `wy_dim_actor` (`actor_key`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `dim_film_dim_film_actor_bridge_fk` FOREIGN KEY (`film_key`) REFERENCES `wy_dim_film` (`film_key`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `wy_dim_location_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_location_address` (
  ...
  CONSTRAINT `dim_location_city_dim_location_address_fk` FOREIGN KEY (`location_city_key`) REFERENCES `wy_dim_location_city` (`location_city_key`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `wy_dim_location_city`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_location_city` (
  ...
  CONSTRAINT `dim_location_country_dim_location_city_fk` FOREIGN KEY (`location_country_key`) REFERENCES `wy_dim_location_country` (`location_country_key`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `wy_dim_location_country`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_location_country` (
...
DROP TABLE IF EXISTS `wy_dim_staff`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_staff` (
...
DROP TABLE IF EXISTS `wy_dim_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_store` (
  ...
  CONSTRAINT `dim_location_address_dim_store_fk` FOREIGN KEY (`location_address_key`) REFERENCES `wy_dim_location_address` (`location_address_key`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `wy_dim_time`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wy_dim_time` (
...
CREATE TABLE `wy_fact_rental` (
  ...
  CONSTRAINT `dim_customer_fact_rental_fk` FOREIGN KEY (`customer_key`) REFERENCES `wy_dim_customer` (`customer_key`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dim_date_fact_rental_fk` FOREIGN KEY (`rental_date_key`) REFERENCES `wy_dim_date` (`date_key`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dim_date_fact_rental_fk1` FOREIGN KEY (`return_date_key`) REFERENCES `wy_dim_date` (`date_key`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dim_film_fact_rental_fk` FOREIGN KEY (`film_key`) REFERENCES `wy_dim_film` (`film_key`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dim_staff_fact_rental_fk` FOREIGN KEY (`staff_key`) REFERENCES `wy_dim_staff` (`staff_key`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dim_store_fact_rental_fk` FOREIGN KEY (`store_key`) REFERENCES `wy_dim_store` (`store_key`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `dim_time_fact_rental_fk` FOREIGN KEY (`return_time_key`) REFERENCES `wy_dim_time` (`time_key`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
